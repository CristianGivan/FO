...
INSERT INTO `account` VALUES (1,10,'2023-06-01 13:14:15','account1','type1',1),(2,20,'2023-06-04 15:44:15','account2','type2',1),(3,30,'2023-06-04 15:44:18','account3','type3',1),(4,44,'2023-06-04 15:44:21','account33','type33',1),(5,46,'2023-06-04 15:44:26','account333','type333',1);
...
INSERT INTO `account_expenses_seq` VALUES (1);
...
INSERT INTO `expenses` VALUES (1,NULL,NULL,'2023-06-25 09:23:34',NULL,NULL,NULL,NULL,'expense1',NULL,NULL,1,NULL),(2,NULL,NULL,'2023-06-25 09:25:32',NULL,NULL,NULL,NULL,'expense1',NULL,NULL,1,NULL);
...
INSERT INTO `expenses_expense_seq` VALUES (3);
...
INSERT INTO `expenses_seq` VALUES (3);
/*!40000 ALTER TABLE `expenses_seq` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `expenses_shop`
--

DROP TABLE IF EXISTS `expenses_shop`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `expenses_shop` (
  `expenses_shop_id` bigint NOT NULL,
  `expenses_date` datetime DEFAULT NULL,
  `expenses_id` bigint DEFAULT NULL,
  `shop_id` bigint DEFAULT NULL,
  PRIMARY KEY (`expenses_shop_id`),
  KEY `FK25iqtwprorqk45fg0kfbw40be` (`expenses_id`),
  KEY `FKcuo3negms4sfalcfc4lqobanc` (`shop_id`),
  CONSTRAINT `FK25iqtwprorqk45fg0kfbw40be` FOREIGN KEY (`expenses_id`) REFERENCES `expenses` (`expenses_id`),
  CONSTRAINT `FKcuo3negms4sfalcfc4lqobanc` FOREIGN KEY (`shop_id`) REFERENCES `shop` (`shop_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `expenses_shop`
--

LOCK TABLES `expenses_shop` WRITE;
/*!40000 ALTER TABLE `expenses_shop` DISABLE KEYS */;
/*!40000 ALTER TABLE `expenses_shop` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `expenses_shop_seq`
--

DROP TABLE IF EXISTS `expenses_shop_seq`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `expenses_shop_seq` (
  `next_val` bigint DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `expenses_shop_seq`
--

LOCK TABLES `expenses_shop_seq` WRITE;
/*!40000 ALTER TABLE `expenses_shop_seq` DISABLE KEYS */;
INSERT INTO `expenses_shop_seq` VALUES (1);
/*!40000 ALTER TABLE `expenses_shop_seq` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `expenses_user` VALUES (1,'2023-06-25 09:25:32',2,1),(2,'2023-06-25 09:25:33',1,1);
...
INSERT INTO `expenses_user_seq` VALUES (2);
...
-- Dump completed on 2023-06-25 10:30:26
