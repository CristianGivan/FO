...
INSERT INTO `account_tasks_seq` VALUES (1);
...
INSERT INTO `account_topic_seq` VALUES (1);
...
INSERT INTO `transaction_account_seq` VALUES (1);
...
INSERT INTO `account_user_seq` VALUES (1);
...
CREATE TABLE `dates_history` (
  ...
  KEY `FKiu4hk2d75kubsx1ipary9x784` (`user_id`),
  CONSTRAINT `FKiu4hk2d75kubsx1ipary9x784` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `email_seq` VALUES (1);
...
INSERT INTO `email_user_seq` VALUES (1);
...
INSERT INTO `expense_seq` VALUES (1);
...
INSERT INTO `expense_user_seq` VALUES (1);
...
CREATE TABLE `person_dates` (
  ...
  KEY `FKq0suon0wgpopislf62pb6ihnj` (`the_dates_id`),
  CONSTRAINT `FKi2aks8htqc1tearwr1q9eg2qy` FOREIGN KEY (`person_id`) REFERENCES `person` (`person_id`),
  CONSTRAINT `FKq0suon0wgpopislf62pb6ihnj` FOREIGN KEY (`the_dates_id`) REFERENCES `dates` (`dates_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `phone_number_seq` VALUES (1);
...
INSERT INTO `phone_number_user_seq` VALUES (1);
...
CREATE TABLE `reminder` (
  ...
  KEY `FKf8f1tut8taixqd04irdelhdyn` (`dates_id`),
  ...
  CONSTRAINT `FKf8f1tut8taixqd04irdelhdyn` FOREIGN KEY (`dates_id`) REFERENCES `dates` (`dates_id`),
...
INSERT INTO `tag_user_seq` VALUES (1);
...
INSERT INTO `task_user_seq` VALUES (1);
...
INSERT INTO `tasks_user_seq` VALUES (1);
...
INSERT INTO `topic_seq` VALUES (1);
...
INSERT INTO `topic_user_seq` VALUES (1);
...
INSERT INTO `transaction_user_seq` VALUES (1);
...
-- Dump completed on 2023-06-13 23:27:05
