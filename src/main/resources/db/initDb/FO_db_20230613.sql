...
INSERT INTO `account` VALUES (1,15,'2023-06-01 13:14:15','account1','type1',1),(2,20,'2023-06-04 15:44:15','account2','type2',1),(3,32,'2023-06-04 15:44:18','account3','type3',1),(4,40,'2023-06-04 15:44:21','account33','type33',1),(5,49,'2023-06-04 15:44:26','account333','type333',1);
...
INSERT INTO `account_transaction` VALUES (1,'2023-06-09 09:02:10',2,11,1,'from'),(2,'2023-06-09 09:02:10',1,11,1,'to'),(3,'2023-06-09 09:02:51',3,12,1,'from'),(4,'2023-06-09 09:02:51',4,12,1,'to deleted'),(5,'2023-06-09 09:51:42',5,11,1,'from deleted'),(6,'2023-06-09 09:53:32',5,12,1,'to deleted'),(7,'2023-06-09 09:54:25',1,12,1,'to');
...
INSERT INTO `account_transaction_seq` VALUES (8);
...
INSERT INTO `address_user_seq` VALUES (1);
...
INSERT INTO `document_user_seq` VALUES (1);
...
INSERT INTO `email` VALUES (1,'2023-06-13 18:35:31','a@1','email1',1),(2,'2023-06-13 18:35:41','a@2','email2',1),(3,'2023-06-13 18:35:48','a@3','email3',1),(4,'2023-06-13 18:35:57','a@33','email33',1),(5,'2023-06-13 18:36:04','a@333','email333',1);
...
INSERT INTO `email_user` VALUES (1,'2023-06-13 18:35:31',1,1),(2,'2023-06-13 18:35:41',2,1),(3,'2023-06-13 18:35:48',3,1),(4,'2023-06-13 18:35:57',4,1),(5,'2023-06-13 18:36:04',5,1);
...
INSERT INTO `link` VALUES (1,'2023-06-09 12:45:06','link1',1,'ref1'),(2,'2023-06-09 12:45:11','link2',1,'ref2'),(3,'2023-06-09 12:45:15','link3',1,'ref3'),(4,'2023-06-09 12:45:20','link33',1,'ref33'),(5,'2023-06-09 12:45:22','link333',1,'ref333');
...
INSERT INTO `link_reminder` VALUES (1,'2023-06-09 12:47:22',1,1),(2,'2023-06-09 12:47:24',2,2),(3,'2023-06-09 12:47:26',3,3),(4,'2023-06-09 12:47:29',4,4),(5,'2023-06-09 12:47:31',4,5),(6,'2023-06-09 12:47:32',5,5);
...
INSERT INTO `link_tag` VALUES (1,'2023-06-09 12:46:22',1,1),(2,'2023-06-09 12:46:26',2,2),(3,'2023-06-09 12:46:28',3,3),(4,'2023-06-09 12:46:30',4,4),(5,'2023-06-09 12:46:32',4,5),(6,'2023-06-09 12:46:34',5,5);
...
INSERT INTO `link_tasks` VALUES (1,'2023-06-09 12:49:11',1,1),(2,'2023-06-09 12:49:14',2,2),(3,'2023-06-09 12:49:16',3,3),(4,'2023-06-09 12:49:18',4,4),(5,'2023-06-09 12:49:21',4,5),(6,'2023-06-09 12:49:22',5,5);
...
INSERT INTO `link_topic` VALUES (1,'2023-06-09 12:48:37',1,1),(2,'2023-06-09 12:48:40',2,2),(3,'2023-06-09 12:48:42',3,3),(4,'2023-06-09 12:48:45',4,4),(5,'2023-06-09 12:48:46',4,5),(6,'2023-06-09 12:48:48',5,5);
...
INSERT INTO `link_user` VALUES (1,'2023-06-09 12:45:06',1,1),(2,'2023-06-09 12:45:11',2,1),(3,'2023-06-09 12:45:15',3,1),(4,'2023-06-09 12:45:20',4,1),(5,'2023-06-09 12:45:22',5,1),(6,'2023-06-09 12:47:04',1,2),(7,'2023-06-09 12:47:05',2,2);
...
INSERT INTO `link_user_seq` VALUES (8);
...
CREATE TABLE `person` (
  ...
  `related_person` bigint DEFAULT NULL,
  PRIMARY KEY (`person_id`),
  KEY `FK2is3ph79mqcwtkd724syhtjbi` (`user_id`),
  KEY `FK7jp1j8qx3x1mwn6br4tb1on9j` (`related_person`),
  CONSTRAINT `FK2is3ph79mqcwtkd724syhtjbi` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`),
  CONSTRAINT `FK7jp1j8qx3x1mwn6br4tb1on9j` FOREIGN KEY (`related_person`) REFERENCES `person` (`person_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `person` VALUES (1,'2023-06-07 21:35:22','person1',1,NULL,'1',NULL,'1','1','NickName1',NULL),(2,'2023-06-07 21:37:25','person2',1,NULL,'2',NULL,'2','2','NickName2',NULL),(3,'2023-06-07 21:38:00','person3',1,NULL,'3',NULL,'3','3','NickName3',NULL),(4,'2023-06-07 21:38:06','person4',1,NULL,'33',NULL,'33','33','NickName33',NULL),(5,'2023-06-07 21:45:37','person5',1,NULL,'333',NULL,'333','333','NickName333',NULL);
...
INSERT INTO `person_address_seq` VALUES (1);
...
INSERT INTO `person_document_seq` VALUES (1);
...
INSERT INTO `person_email_seq` VALUES (1);
...
INSERT INTO `person_phone_number_seq` VALUES (1);
...
CREATE TABLE `person_dates` (
  ...
  `person_date` datetime DEFAULT NULL,
  `person_id` bigint DEFAULT NULL,
  `the_dates_id` bigint DEFAULT NULL,
  PRIMARY KEY (`person_dates_id`),
  KEY `FKbc7tftjtk4eankcapbeyfa4op` (`person_id`),
  KEY `FKpkq1ioj42jotxgf35ntptoig6` (`the_dates_id`),
  CONSTRAINT `FKbc7tftjtk4eankcapbeyfa4op` FOREIGN KEY (`person_id`) REFERENCES `person` (`person_id`),
  CONSTRAINT `FKpkq1ioj42jotxgf35ntptoig6` FOREIGN KEY (`the_dates_id`) REFERENCES `dates` (`dates_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `person_dates_seq` VALUES (1);
/*!40000 ALTER TABLE `person_dates_seq` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `person_the_dates`
--

DROP TABLE IF EXISTS `person_the_dates`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `person_the_dates` (
  `person_the_dates_id` bigint NOT NULL,
  `person_date` datetime DEFAULT NULL,
  `person_id` bigint DEFAULT NULL,
  `the_dates_id` bigint DEFAULT NULL,
  PRIMARY KEY (`person_the_dates_id`),
  KEY `FK3mhshrcq9218q3iok5v2vudn` (`person_id`),
  KEY `FKjfoaah6v6cfcjpq9068phsb2e` (`the_dates_id`),
  CONSTRAINT `FK3mhshrcq9218q3iok5v2vudn` FOREIGN KEY (`person_id`) REFERENCES `person` (`person_id`),
  CONSTRAINT `FKjfoaah6v6cfcjpq9068phsb2e` FOREIGN KEY (`the_dates_id`) REFERENCES `dates` (`dates_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `person_the_dates`
--

LOCK TABLES `person_the_dates` WRITE;
/*!40000 ALTER TABLE `person_the_dates` DISABLE KEYS */;
/*!40000 ALTER TABLE `person_the_dates` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `person_the_dates_seq`
--

DROP TABLE IF EXISTS `person_the_dates_seq`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `person_the_dates_seq` (
  `next_val` bigint DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `person_the_dates_seq`
--

LOCK TABLES `person_the_dates_seq` WRITE;
/*!40000 ALTER TABLE `person_the_dates_seq` DISABLE KEYS */;
INSERT INTO `person_the_dates_seq` VALUES (1);
/*!40000 ALTER TABLE `person_the_dates_seq` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `phone_number` VALUES (1,'2023-06-13 19:10:48','1','1',1),(2,'2023-06-13 20:56:41','2','pn2',1),(3,'2023-06-13 20:56:50','3','pn3',1),(4,'2023-06-13 20:56:56','33','pn33',1),(5,'2023-06-13 20:57:04','333','pn333',1);
...
INSERT INTO `phone_number_user` VALUES (1,'2023-06-13 19:10:48',1,1),(2,'2023-06-13 20:56:41',2,1),(3,'2023-06-13 20:56:50',3,1),(4,'2023-06-13 20:56:56',4,1),(5,'2023-06-13 20:57:04',5,1);
...
CREATE TABLE `reminder` (
  ...
  KEY `FK6cg4g2yak08v11amyyp8bqha` (`email_id`),
  KEY `FK6tr5wejga4p3qdr8h1w7ayaw1` (`phone_number_id`),
  KEY `FK1m4gfciyl5kme7f1l9odckkq6` (`dates_id`),
  CONSTRAINT `FK15pf8wf1i0chw5j61m2jxt2k` FOREIGN KEY (`person_id`) REFERENCES `person` (`person_id`),
  CONSTRAINT `FK1m4gfciyl5kme7f1l9odckkq6` FOREIGN KEY (`dates_id`) REFERENCES `dates` (`dates_id`),
  CONSTRAINT `FK4ycb9lmxnn1xyykovyxpf9eb0` FOREIGN KEY (`repeated_reminders`) REFERENCES `reminder` (`reminder_id`),
  CONSTRAINT `FK6cg4g2yak08v11amyyp8bqha` FOREIGN KEY (`email_id`) REFERENCES `email` (`email_id`),
  CONSTRAINT `FK6tr5wejga4p3qdr8h1w7ayaw1` FOREIGN KEY (`phone_number_id`) REFERENCES `phone_number` (`phone_number_id`),
...
CREATE TABLE `task_history` (
  ...
  KEY `FKla5crfo9yy44jsg60e7uer4uk` (`dates_id`),
  ...
  CONSTRAINT `FKla5crfo9yy44jsg60e7uer4uk` FOREIGN KEY (`dates_id`) REFERENCES `dates` (`dates_id`),
...
CREATE TABLE `dates` (
  ...
  KEY `FK326stguw59ocd7iniuyam0686` (`user_id`),
  CONSTRAINT `FK326stguw59ocd7iniuyam0686` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `dates_history`
--

DROP TABLE IF EXISTS `dates_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dates_history` (
  `dates_history_id` bigint NOT NULL,
  `modified_date` datetime DEFAULT NULL,
  `dates_id` bigint DEFAULT NULL,
  `user_id` bigint DEFAULT NULL,
  PRIMARY KEY (`dates_history_id`),
  KEY `FK7e8h7nurlfhk1i83btyce6vxe` (`dates_id`),
  KEY `FKbbxq9v6m1ikxevil89g6uindg` (`user_id`),
  CONSTRAINT `FK7e8h7nurlfhk1i83btyce6vxe` FOREIGN KEY (`dates_id`) REFERENCES `dates` (`dates_id`),
  CONSTRAINT `FKbbxq9v6m1ikxevil89g6uindg` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `dates_history`
--

LOCK TABLES `dates_history` WRITE;
/*!40000 ALTER TABLE `dates_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `dates_history` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `dates_reminder` (
  ...
  KEY `FKincfil23w9kluhckeg839g5ul` (`reminder_id`),
  KEY `FK6yjkd5m104eugyuo2q7nciloj` (`dates_id`),
  CONSTRAINT `FK6yjkd5m104eugyuo2q7nciloj` FOREIGN KEY (`dates_id`) REFERENCES `dates` (`dates_id`),
  CONSTRAINT `FKincfil23w9kluhckeg839g5ul` FOREIGN KEY (`reminder_id`) REFERENCES `reminder` (`reminder_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `dates_seq` VALUES (1);
...
CREATE TABLE `dates_tag` (
  ...
  KEY `FKb303s6vy59ibb8nttlp2rq09i` (`tag_id`),
  KEY `FKdaitp3e7nlgds7x8ajx1trcds` (`dates_id`),
  CONSTRAINT `FKb303s6vy59ibb8nttlp2rq09i` FOREIGN KEY (`tag_id`) REFERENCES `tag` (`tag_id`),
  CONSTRAINT `FKdaitp3e7nlgds7x8ajx1trcds` FOREIGN KEY (`dates_id`) REFERENCES `dates` (`dates_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dates_tasks` (
  ...
  KEY `FKoadgo0xnqn6v44947qgiwg7sy` (`tasks_id`),
  KEY `FKcyornpgmlxdd16efe37jcfuf1` (`dates_id`),
  CONSTRAINT `FKcyornpgmlxdd16efe37jcfuf1` FOREIGN KEY (`dates_id`) REFERENCES `dates` (`dates_id`),
  CONSTRAINT `FKoadgo0xnqn6v44947qgiwg7sy` FOREIGN KEY (`tasks_id`) REFERENCES `tasks` (`tasks_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dates_topic` (
  ...
  KEY `FKphdfpmv5hk60vxf0lqwcr18mc` (`dates_id`),
  KEY `FKnma6td5xhx7656aq3be3fbndr` (`topic_id`),
  CONSTRAINT `FKnma6td5xhx7656aq3be3fbndr` FOREIGN KEY (`topic_id`) REFERENCES `topic` (`topic_id`),
  CONSTRAINT `FKphdfpmv5hk60vxf0lqwcr18mc` FOREIGN KEY (`dates_id`) REFERENCES `dates` (`dates_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dates_user` (
  ...
  KEY `FKg7gtm7muoc17ol2ds8svuuhjk` (`dates_id`),
  KEY `FK3y7xq30pgnd5sph8npdmmf1bc` (`user_id`),
  CONSTRAINT `FK3y7xq30pgnd5sph8npdmmf1bc` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`),
  CONSTRAINT `FKg7gtm7muoc17ol2ds8svuuhjk` FOREIGN KEY (`dates_id`) REFERENCES `dates` (`dates_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `dates_user_seq` VALUES (1);
...
INSERT INTO `transaction` VALUES (1,'2023-06-04 22:26:17','transaction1',1,1,'type1'),(2,'2023-06-04 22:26:27','transaction2',1,2,'type2'),(3,'2023-06-04 22:26:34','transaction3',1,3,'type3'),(4,'2023-06-04 22:26:39','transaction4',1,4,'type33'),(5,'2023-06-04 22:26:47','transaction5',1,5,'type333'),(11,'2023-06-09 09:02:10','transaction111',1,1,NULL),(12,'2023-06-09 09:02:51','transaction34',1,4,NULL);
...
INSERT INTO `transaction_user` VALUES (1,'2023-06-04 22:26:17',1,1),(2,'2023-06-04 22:26:27',2,1),(3,'2023-06-04 22:26:34',3,1),(4,'2023-06-04 22:26:39',4,1),(5,'2023-06-04 22:26:47',5,1),(6,'2023-06-09 09:02:10',11,1),(7,'2023-06-09 09:02:51',12,1);
...
INSERT INTO `transaction_user_seq` VALUES (8);
...
-- Dump completed on 2023-06-13 21:51:35
